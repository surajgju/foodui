...
class CompactCard3 extends StatelessWidget {
  CompactCard3({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (){
        Navigator.of(context).pushNamed(RestaurantDetailViewScreen.routeName,arguments: {"restaurantId":_id});
      },
      child: Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 10.w),
                      Icon(Icons.pedal_bike,color:Colors.black54,),
                      Text('ADE 7.50',style: TextStyle(color: Colors.black54),)
                    ],
                  )
                ],
              ),
