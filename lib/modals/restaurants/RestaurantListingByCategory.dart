...
/// data : [{"id":8,"name":"Mcdonalds Sector 63","email":"sunill@qconnect.com","phone":"987657890","password":"17aa1eb864dfc173fa7b67c05672591c","address":"McDonald's, Plot No. H-224-I Sector 63, Vishwakarma Rd, Noida, Uttar Pradesh 201301","user_type":1,"brand_name":"Mcdonalds","store_type":"Restaurant","branch":"Sector 63","roll_business":"Owner/Partner","restaurant_name":"Mcdonalds Sector 63","restaurent_phone":"987654321","pincode":"201309","city":"Noida","landline_number":"-9876545689","owner_mob_number":"9765456789","owner_name":"Sunil","owner_email":"sunill@qconnect.com","img1":"202311021725download (2).jfif","img2":null,"gender":"NULL","dob":"NULL","newsletter_check":"NULL","sms_check":"NULL","status":"Active","created_at":"2023-11-04 12:42:23","updated_at":"2023-11-04 12:42:23","minimum_order":"NULL","working_hours":"NULL","delivery_time":"NULL","delivery_fee":"NULL","plus_code":"J9FG+R2 Noida, Uttar Pradesh, India","pre_order":"NULL","open_at":"","close_at":"NULL"}]

class RestaurantListingByCategory {
  RestaurantListingByCategory({
      this.status, 
      this.message, 
      this.data,});

  RestaurantListingByCategory.fromJson(dynamic json) {
    status = json['status'];
