...
class OfferHomeScreen extends StatefulWidget {
  static const routeName = "/offerHomeScreen";

  const OfferHomeScreen({super.key});

  @override
  State<OfferHomeScreen> createState() => _FoodHomeScreenState();
}

class _FoodHomeScreenState extends State<OfferHomeScreen> {
